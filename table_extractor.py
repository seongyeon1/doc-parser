...
class TableExtractor:
    ...
    async def extract_tables_with_gpt5(self, text: str) -> Dict[str, Any]:
        """
        GPT-4o를 사용하여 텍스트에서 표를 추출하고 JSON과 Markdown으로 정리합니다.
        ...
        try:
            ...
            # 응답 파싱 및 정리
            result = self._parse_and_clean_response(response)
    ...
    async def extract_tables_from_image(self, image_content: bytes, file_extension: str) -> Dict[str, Any]:
        """
        GPT-4o Vision을 사용하여 이미지에서 직접 표를 추출합니다.
        ...
        try:
            ...
            # 응답 파싱 및 정리
            result = self._parse_and_clean_response(response.choices[0].message.content)
    ...
    def _parse_and_clean_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "extraction_method": f"GPT-4o Vision ({self.model})"
            }
